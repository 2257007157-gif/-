...
| `codex.websocket.event`               | counter   | `kind`, `success`   | WebSocket message/event count by type.                            |
...
| `websocket.event`                               | counter   | `kind`, `success`    | WebSocket message/event count by type.                       |
...
| `windows_sandbox.setup_duration_ms`              | histogram | `result`, `originator`, `mode`            | Windows sandbox setup duration by result.             |
...
| `windows_sandbox.elevated_setup_duration_ms`     | histogram | `result`                                  | Elevated sandbox setup duration by result.            |
